...
class SweetsControllerTest < ActionController::TestCase
  ...
  test "should create sweet" do
    assert_difference('Sweet.count') do
      post :create, sweet: { message: @sweet.message, parent_id: @sweet.parent_id, user_id: @sweet.user_id }
    end
  ...
  test "should update sweet" do
    patch :update, id: @sweet, sweet: { message: @sweet.message, parent_id: @sweet.parent_id, user_id: @sweet.user_id }
    assert_redirected_to sweet_path(assigns(:sweet))
  end
